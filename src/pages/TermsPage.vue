...
useSeoMeta({
  ...
  description: 'The terms that govern your use of the YM² Android application.',
  path: '/terms',
})
    ...
    <RevealSection class="mx-auto max-w-3xl">
      ...
      <div class="mt-10 space-y-10 text-ink/80">
        ...
        <section aria-labelledby="liability">
          ...
          <p class="mt-3 leading-relaxed">
            To the maximum extent permitted by law, YM²'s developers shall not be liable for any
            ...
            arising from your use of or inability to use YM².
          </p>
        </section>
